...
const AddAProduct = () => {
    ...
    return (
        <div className="container mt-2">
            <h3 className="">Provide New Product info</h3>
            <form className="mx-5" onSubmit={handleSubmitMassage}>
                ...
                <input type="number" name="price" onBlur={handleOnBlur} placeholder="Provide Product Price" className="form-control rounded-3 bg-white border-0 shadow-sm px-4" />
                <br />
                <p className=" my-0 ms-4 text-start"><small>Product Image URL:</small></p>
                <input type="text" name="image" onBlur={handleOnBlur} placeholder="Provide Product image URL" className="form-control rounded-3 bg-white border-0 shadow-sm px-4" />
                <br />
                ...
                <div className="d-grid gap-2 mt-2">
                    <button type="submit" className="btn btn-primary btn-block text-uppercase mb-2 rounded-pill shadow-sm">Add Product</button>
                </div>
            </form>
        </div>
    );
